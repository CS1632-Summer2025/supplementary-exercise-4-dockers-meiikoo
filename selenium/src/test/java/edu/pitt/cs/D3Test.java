...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    .until(ExpectedConditions.elementToBeClickable(By.linkText("Reset")));
    
    WebElement element = driver.findElement(By.linkText("Reset"));
    String attribute = element.getAttribute("href");
    String relHref = attribute.substring(attribute.indexOf("/reset")); 
    
    // 4 | assert | linkHref | /reset
    assertEquals(relHref, "/reset");
    // 5 | close |  | 
    // driver.close();
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    new WebDriverWait(driver, Duration.ofSeconds(10))
    .until(ExpectedConditions.elementToBeClickable(By.linkText("Catalog")))
    .click();
    ...
    assertTrue(attribute.endsWith("/images/cat2.jpg"));
  ...
  public void tEST5RENTACAT() {
    ...
    new WebDriverWait(driver, Duration.ofSeconds(10))
    .until(ExpectedConditions.elementToBeClickable(By.linkText("Rent-A-Cat")))
    .click();
  ...
  public void tEST8FEEDACAT() {
    ...
    new WebDriverWait(driver, Duration.ofSeconds(10))
    .until(ExpectedConditions.elementToBeClickable(By.linkText("Feed-A-Cat")))
    .click();
  ...
  public void tEST10GREETACAT() {
    ...
    new WebDriverWait(driver, Duration.ofSeconds(10))
    .until(ExpectedConditions.elementToBeClickable(By.linkText("Greet-A-Cat")))
    .click();
